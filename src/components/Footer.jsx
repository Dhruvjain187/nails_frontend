                    ...
                    <div className="border">
                        <div className="logo">
                            <div className="col-flex">
                                ...
                                <span className="exception">Keep up with the latest nail and trends.</span>
                                <ul className="flex-i">
                                    <li><i className="fa-brands fa-facebook-f fa-2xl"></i></li>
                                    <li><i className="fa-brands fa-square-x-twitter fa-2xl"></i></li>
                                    <li><i className="fa-brands fa-instagram fa-2xl"></i></li>
                                    <li><i className="fa-brands fa-square-pinterest fa-2xl"></i></li>
                                </ul>
                            </div>

                            <div className="col-flex">
                                <div>
                                    <div className="size-18 exception-2">FIND US</div>
                                    <p className="flex-para">
                                        <span><i className="fa-solid fa-location-dot fa-lg"></i></span>
                                        <a href="">4809 Buford Hwy Atlanta<br />GA, US 30341</a>
                                    </p>
                                    <p className="flex-para">
