import { MainHeader, Header1, Header2, NavAnchor, ListAnchor } from "../styles/Header"
    ...
    return (
        <>
            <MainHeader theme={theme}>
                ...
                <Header1 theme={theme}>
                    <label htmlFor="menu">
                        <div className="menu"><i className="fa-solid fa-bars fa-lg"></i></div>
                    </label>
                ...
                <Header2 theme={theme} id="header-2">
                    <nav>
                        <div className="box shop-a">
                            ...
                            <ul className="shop">
                                <li>
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Acrylics</ListAnchor>
                                    ...
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Dispsibles & Sanitation</ListAnchor>
                                    ...
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Tips</ListAnchor>
                                ...
                                <li>
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Manicure & Pedicure</ListAnchor>
                                    ...
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Waxing</ListAnchor>
                                ...
                                <li>
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Nail Art</ListAnchor>
                                    ...
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Builder Gel</ListAnchor>
                                ...
                                <li>
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Salon Essentials</ListAnchor>
                                ...
                                <li>
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Soft Gel</ListAnchor>
                                    ...
                                    <div>
                                        <ListAnchor padding="0 0 10px" colors="#8e7069">Tools & Implements</ListAnchor>
                        ...
                        <div className="box best">
                            ...
                            <ul className="shop best-shop">
                                <li>
                                    <div>
                                        <ListAnchor >Trending</ListAnchor>
                        ...
                        <div className="box"><NavAnchor ><span>Store Pickup</span></NavAnchor></div>
                    </nav>
                    <label className="close" htmlFor="menu"><i className="fa-solid fa-xmark fa-lg"></i></label>
                </Header2>
